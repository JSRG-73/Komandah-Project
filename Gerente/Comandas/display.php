...
<body>
    ...
    <table id="customers">
        ...
        $con = conectar();
        $sql = "SELECT id_comanda,id_mesa,descripcion FROM comandas WHERE completada = 0";
        ...
        if ($resultado) {
            while ($row = mysqli_fetch_assoc($resultado)) {
                ...
                <tr>
                    ...
                    <td>' . $descripcion . '</td> 
                    <td>
                        <button class="btn btn-warning" onclick=marcarCompletada('.$idcomanda.');>Marcar Completada</a></button>
                        </td>
